...
<div id="registrations" class="w-full h-full flex items-center justify-center bg-gray-100/80 select-none blur-sm mt-10">
    ...
    <!-- <div class="mt-20 pb-[50px] pt-16 text-center text-3xl font-[450]">
            COMING SOON
        </div> -->
    <!-- </div class="mx-auto">
    ...
    <div class="flex justify-end">
      <button class="w-[140px] h-[50px] bg-gradient-to-r from-pink-500 via-red-500 to-yellow-500 border border-black text-white font-bold transform hover:scale-105 transition-transform duration-300 cursor-pointer shadow-lg mb-4">
        ...
        <div class="flex text-md md:text-lg md:text-xl py-3 bg-[#e9e9e9]">
            ...
            <div class='w-1 h-auto border-r-2 border-white'></div>
            <div class="w-1/3 text-center">7,000</div>
            <div class='w-1 h-auto border-r-2 border-white'></div>
            <div class="w-1/3 text-center">125</div>
        </div>
        <div class="flex text-md md:text-lg md:text-xl py-3 ">
            ...
            <div class="w-1/3 text-center">9,000</div>
            <div class='w-1 h-auto border-r-2 border-[#e9e9e9]'></div>
        ...
        <div class="flex text-md md:text-lg md:text-xl py-3 bg-[#e9e9e9]">
            ...
            <div class='w-1 h-auto border-r-2 border-white'></div>
            <div class="w-1/3 text-center">12,000 </div>
            <div class='w-1 h-auto border-r-2 border-white'></div>
        ...
        <div class="flex text-md md:text-lg md:text-xl py-3">
            ...
            <div class='w-1 h-auto border-r-2 border-[#e9e9e9]'></div>
            <div class="w-1/3 text-center">1,000</div>
            <div class='w-1 h-auto border-r-2 border-[#e9e9e9]'></div>
            <div class="w-1/3 text-center">25</div>
        </div>
        <div class="flex text-md md:text-lg md:text-xl py-3 bg-[#e9e9e9]">
            <div class="w-1/3 text-center">Extra Pages (After 12 pages)</div>
            <div class='w-1 h-auto border-r-2 border-white'></div>
            <div class="w-1/3 text-center">500 Per Page</div>
            <div class='w-1 h-auto border-r-2 border-white'></div>
            <div class="w-1/3 text-center">15 Per Page</div>
        </div> -->
    <!-- <div class="flex   text-md md:text-lg md:text-xl py-3">
            <div class="w-1/3 text-center">Journal</div>
            <div class='w-1 h-auto border-r-2 border-[#e9e9e9]'></div>
