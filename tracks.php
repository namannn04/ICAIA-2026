<div id="tracks" class="w-full h-full flex items-center justify-center select-none bg-gray-100/80 backdrop-blur-sm mt-10">
    <h2 class='text-center text-[100px] z-50 blur-sm text-gray-500 font-semibold'>Revealing Soon Tracks !!</h2>
</div>
<!-- <div class="w-full" >
    ...
    <ul class="space-y-2">
        ...
        <li class="relative">
            <button type="button"
                ...
                Track VI: AI for Human Machine Interaction
            </button>
            <ul id="track6"
                class="md:absolute left-full top-0 mt-2 ml-2 w-[400px] md:w-[800px] bg-white rounded-md shadow-lg hidden text-left dropdown-menu open">
                <li class="px-3 py-1">●	Natural Language Processing (NLP) for HMI</li>
                <li class="px-3 py-1">●	Emotion Recognition and Sentiment Analysis</li>
                <li class="px-3 py-1">●	Computer Vision for Gesture and Facial Recognition </li>
                <li class="px-3 py-1">●	Augmented and Virtual Reality in HMI</li>
                <li class="px-3 py-1">●	Personalization and Adaptive Interfaces</li>
            </ul>
        </li>
        <li class="relative">
            <button type="button"
                ...
                Track VII: Renewal Energy & Sustainable Energy
            </button>
            <ul id="track7"
                class="md:absolute left-full top-0 mt-2 ml-2 w-[400px] md:w-[800px] bg-white rounded-md shadow-lg hidden text-left dropdown-menu open">
                <li class="px-3 py-1">●	AI for Renewable Energy Forecasting</li>
                <li class="px-3 py-1">●	Energy Efficiency Optimization using AI</li>
                <li class="px-3 py-1">●	Smart Grid and Energy Management Systems</li>
                <li class="px-3 py-1">●	AI for Energy Storage and Battery Management</li>
                <li class="px-3 py-1">●	AI for Renewable Energy Integration</li>
            </ul>
        </li>
        <li class="relative">
